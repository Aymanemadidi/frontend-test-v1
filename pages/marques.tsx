...
export default function Demo({ opened }: any) {
	...
	const [getEmailsBySearch, results] = useLazyQuery(GET_marques_BY_OC);
	...
	const toggleAll = () =>
		setSelection((current) =>
			current.length === marquesData.length
				? []
				: marquesData.map((item: any) => item.userId)
		);
